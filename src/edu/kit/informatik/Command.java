...
public enum Command {
    ...
    CMD_ROWPRINT("rowprint (\\d+)") {
        ...
        public void commandMethod(MatchResult matcher, ConnectSix connectSix)
            ...
            System.out.println(connectSix.printBoardLine(row, horizontal));
        }
    },
    ...
    CMD_COLPRINT("colprint (\\d+)") {
        ...
        public void commandMethod(MatchResult matcher, ConnectSix connectSix)
            ...
            System.out.println(connectSix.printBoardLine(column, horizontal));
        }
    },
     ...
     * user wants to quit the game by the command quit or by entering false
     * command line arguments at the beginning of the game.
     */

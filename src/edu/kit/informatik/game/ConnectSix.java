...
public class ConnectSix {
    ...
    public ConnectSix() {
        ...
        setGameCounter(0);
        this.minEdgeLength = 17;
        this.maxEdgeLength = 21;
        this.minAmountOfPlayers = 2;
    }
     ...
     *            Array of strings which contains the game mode specification.
     * @return True, if the command line input contains exactly three main characteristics: Game mode, which can be
     *         "standard" or "torus". Field size factor, which has a given minimum and maximum length and also has to be
     *         an even number. Number of players, who are a minimum of two and a maximum of four. False, if not.
     */
    public boolean entryCheck(final String[] commandLineInput) {
        ...
        try {
            if (commandLineInput.length == 3
                    ...
                    && Integer.parseInt(commandLineInput[1]) > minEdgeLength
                    && Integer.parseInt(commandLineInput[1]) < maxEdgeLength
                    && Integer.parseInt(commandLineInput[1]) % 2 == 0
                    && Integer.parseInt(commandLineInput[2]) >= minAmountOfPlayers
    ...
    /**
     * Returns "OK" as an answer of the method's execution and sets token based on the current game mode.
     * 
     * @param firstRow
     ...
     *             if anything of the token positions are invalid.
     */
